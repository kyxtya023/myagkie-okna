...
const cards: WhyUsCard[] = [
  ...
  },
  {
    ...
    description: 'Предоставляем официальную гарантию на материалы и выполненные работы',
    alt: 'Иконка гарантийного сертификата'
  },
  {
    id: 6,
    icon: 'delivery',
    title: 'Доставка по области',
    description: 'Бесплатная доставка готовых изделий в пределах 50 км от города',
    alt: 'Иконка доставки'
  },
  {
    id: 7,
  ...
  },
  {
    ...
    icon: 'speed',
    title: 'Быстрые сроки',
    description: 'Изготовление от 3 дней, монтаж за 1-2 дня в зависимости от объема',
